...
cp --preserve=timestamps -f ./cairo/cairo-1.18.2-2-x86_64.pkg.tar.zst ./packages/pango_depends_MSYS_64bit_packages/
cp --preserve=timestamps -f ./harfbuzz/harfbuzz-10.1.0-1-x86_64.pkg.tar.zst ./packages/pango_depends_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./cairo/cairo-1.18.2-2-i686.pkg.tar.zst ./packages/pango_depends_MSYS_32bit_packages/
cp --preserve=timestamps -f ./harfbuzz/harfbuzz-10.1.0-1-i686.pkg.tar.zst ./packages/pango_depends_MSYS_32bit_packages/
