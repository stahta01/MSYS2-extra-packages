...
cp --preserve=timestamps -f ./libogg/libogg-1.3.5-4-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
cp --preserve=timestamps -f ./libpng/libpng-1.6.44-1-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
cp --preserve=timestamps -f ./flac/flac-1.4.3-3-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./sdl3/sdl3-3.4.14-2-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
cp --preserve=timestamps -f ./sdl2-compat/sdl2-compat-2.32.70-2-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./libogg/libogg-1.3.5-4-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
cp --preserve=timestamps -f ./libpng/libpng-1.6.44-1-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
cp --preserve=timestamps -f ./flac/flac-1.4.3-3-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
...
cp --preserve=timestamps -f ./sdl3/sdl3-3.4.14-2-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
cp --preserve=timestamps -f ./sdl2-compat/sdl2-compat-2.32.70-2-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
