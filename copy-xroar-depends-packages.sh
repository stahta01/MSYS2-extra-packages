...
cp --preserve=timestamps -f ./sdl3/sdl3-3.4.14-1-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./sdl3/sdl3-3.4.14-1-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
