...
cp --preserve=timestamps -f ./sdl2/sdl2-2.30.8-2-x86_64.pkg.tar.zst ./packages/xroar_depends_MSYS_64bit_packages/
...
cp --preserve=timestamps -f ./sdl2/sdl2-2.30.8-2-i686.pkg.tar.zst ./packages/xroar_depends_MSYS_32bit_packages/
